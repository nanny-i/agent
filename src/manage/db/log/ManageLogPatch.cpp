...
INT32		CManageLogPatch::LoadDBMS()
{
	...
	{
		AddItem(*begin);
		AddKeySubIDMap(POS_KEY_ID_POSITION_LOG_PATCH_SID_MAP, begin->nRegSvrID, begin->nID);
		AddKeySubIDMap(POS_KEY_ID_POSITION_LOG_PATCH_PID_MAP, begin->nPatchID, begin->nID);
...
INT32					CManageLogPatch::AddLogPatch(DB_LOG_PATCH&	data)
{
    ...
    AddItem(data);
	AddKeySubIDMap(POS_KEY_ID_POSITION_LOG_PATCH_SID_MAP, data.nRegSvrID, data.nID);
	AddKeySubIDMap(POS_KEY_ID_POSITION_LOG_PATCH_PID_MAP, data.nPatchID, data.nID);
...
INT32					CManageLogPatch::DelLogPatch(UINT32 nID)
{
	...
	DelKeySubIDMap(POS_KEY_ID_POSITION_LOG_PATCH_SID_MAP, pdata->nRegSvrID);
	DelKeySubIDMap(POS_KEY_ID_POSITION_LOG_PATCH_PID_MAP, pdata->nPatchID);
    DeleteItem(nID);
    return 0;
}
//---------------------------------------------------------------------------
