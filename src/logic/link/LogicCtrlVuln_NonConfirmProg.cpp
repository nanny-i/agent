...
INT32		CLogicCtrlVuln::ScanNonConfirmProg_Global(String strSwChkKey, String strSwVersion, TListMemVulnRst& tNotiList)
{
	PDB_HOST_SW pdata = t_ManageHostSw->FindChkKeyVerItem(strSwChkKey, strSwVersion);
	if(!pdata || pdata->nUsedFlag != STATUS_USED_MODE_ON)	return 0;
