...
INT32		CFileUtil::GetEnvPathToLocalPath_Temp(TListStr& tPathList, INT32 nType)
{
	return 0;
}
//---------------------------------------------------------------------------------------------

INT32		CFileUtil::GetEnvPathToLocalPath_UsersEnv(TListStr& tPathList, String strPreKey, UINT32 nRemainLog, UINT32 nEnvWaitSec)
{
	return 0;
}
//---------------------------------------------------------------------------------------------
