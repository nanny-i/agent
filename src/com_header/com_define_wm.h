...
#define     WM_AGENT_INITIALIZE						WM_USER + 0x0011
#define     WM_AGENT_AUTO_DESTORY					WM_USER + 0x0012
#define     WM_AGENT_TERMINATED						WM_USER + 0x0013
...
#define		WM_GLOBAL_THREAD_WORK_END				WM_USER + 0x0041
#define		WM_GLOBAL_THREAD_WORK_PROGRESS			WM_USER + 0x0042
