...
INT32		CManageHostVulnRstUnit::LoadDBMS()
{
    ...
    for(begin; begin != end; begin++)
    {
		...
		AddKeySubIDMap(begin->nVulnRstID, begin->tDHVRUS.nVulnID, begin->nID);
    }
    return 0;
}
//---------------------------------------------------------------------------
...
INT32					CManageHostVulnRstUnit::AddHostVulnRstUnit(DB_HOST_VULN_RST_UNIT&	data)
{
	...
	AddKeySubIDMap(data.nVulnRstID, data.tDHVRUS.nVulnID, data.nID);
    return 0;
}
//---------------------------------------------------------------------------
...
INT32					CManageHostVulnRstUnit::DelHostVulnRstUnit(UINT32 nID)
{
	...
	DelKeySubIDMap(pdata->nVulnRstID, pdata->tDHVRUS.nVulnID);
    DeleteItem(nID);
    return 0;
}
//---------------------------------------------------------------------------
