...
private:
	INT32		GetEnvPathToLocalPath_Temp(TListStr& tPathList, INT32 nType);
	INT32		GetEnvPathToLocalPath_UsersEnv(TListStr& tPathList, String strPreKey, UINT32 nRemainLog = 1, UINT32 nEnvWaitSec = 60);
