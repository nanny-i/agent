...
//	t_ASISIDLLUtil->GetSwInfo(ASISI_REQUEST_SW_INFO_ALL, ASISI_GetSwInfo, &tSwInfoList);
	...
	{			
		...
		for(begin; begin != end; begin++)
		{
			if(pdpdfcu->strCompValue == begin->szName)
			{
				nMatchFind = 1;
				break;
			}
...
VOID		CLogicMgrPoDeployFile::ASISI_GetSwInfo(PASISI_SW_INFO pasi, INT32 nSize, PVOID lParam)
{
	ASISI_SW_INFO tASI;
