...
// 			{
// 				WriteLogN("[%s] check ptn patch util confirm : [%s]-[%s]/[%s]", m_strLogicName.c_str(), pdata->strName, strCurVer, pdata->strTarFVer);
// 				return 0;
// 			}
// 		}
// 	}	
...
// 			strPatchLogListFile = SPrintf("%spatch_list_%u.txt", szTempDir, GetTickCount());
// 			String strCommand;
// 			strCommand = SPrintf("cmd.exe /C wmic.exe qfe get hotfixid > \"%s\"", strPatchLogListFile);
// 
// 			CProcUtil tProcUtil;
...
// 			{
// 				WriteLogE("[%s] make qfe file list fail : [%s]", m_strLogicName.c_str(), strPatchLogListFile);
// 				break;
// 			}
// 			
// 			{
...
// 				if(!lpBuffer)
// 				{
// 					WriteLogE("[%s] read qfe file list fail : [%s]", m_strLogicName.c_str(), strPatchLogListFile);
// 					break;
// 				}
// 
...
// 					break;
// 				}
// 				WriteLogN("[%s] check ptn patch util confirm : [%s]", m_strLogicName.c_str(), pdata->strName);
// 			}
// 
// 			{
// 				CFileUtil tFileUtil;
